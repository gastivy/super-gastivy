...
const ActivityOverviewContainer = () => {
  ...
  return (
    <div className="flex flex-col gap-4 max-[960px]:gap-8">
      <div className="text-xl font-medium text-slate-900 dark:text-slate-100 py-5 bg-white p-6 sticky top-0 max-[960px]:top-4 z-1 rounded-lg max-[960px]:shadow-xl shadow-zinc-800/10">
        {greeting}
      </div>

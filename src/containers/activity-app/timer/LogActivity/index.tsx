...
export const LogActivity: React.FC<LogActivityProps> = ({ data }) => {
  ...
  return (
    <div className="w-[40%] max-[720px]:h-[calc(100dvh-190px)]  max-[720px]:w-full bg-white rounded-xl flex flex-col gap-10 max-[720px]:gap-6 px-4 py-8 max-[720px]:py-4 border border-zinc-700/10">
      ...
      <div className="flex flex-col overflow-y-auto">
        <Each
          ...
          render={({ start_date, end_date }, index) => (
            <div
              className={cn(
                "flex justify-between items-center border-zinc-200 py-2",
            ...
            >
              ...
              <div className="flex flex-col items-end gap-1">
                ...
                <div
                  className={cn("text-xs text-slate-400", end_date ? "" : "")}
                >
                  {end_date
